...
using redis.clients.jedis.JedisPooled;
...
|------|--------|------------|
| `DockerFilesystemSpec` | `AgentScope.Harness.Agent.Sandbox.Impl.Docker` | single-machine / local cluster; container from an image; most familiar |
...
```csharp
using AgentScope.Core.Agent.RuntimeContext;
using AgentScope.Extensions.Redis.RedisDistributedStore;
using AgentScope.Core.Tracing.OtelTracingMiddleware;
using AgentScope.Harness.Agent.DistributedStore;
using AgentScope.Harness.Agent.HarnessAgent;
using AgentScope.Harness.Agent.IsolationScope;
using AgentScope.Harness.Agent.Sandbox.Impl.Docker.DockerFilesystemSpec;
using AgentScope.Core.Memory.Compaction.CompactionConfig;
using AgentScope.Core.Memory.Compaction.ToolResultEvictionConfig;
...
HarnessAgent agent = HarnessAgent.builder()
        ...
        .skillRepository(AgentScope.Core.Skill.Repository.MySql.MysqlSkillRepository
