...
/// <summary>
/// OpenAI text embedding generator. Maps to Java OpenAITextEmbedding.
    ...
    int dimension = 1536) : IEmbeddingGenerator
{
    ...
    /// <summary>API key read from the OPENAI_API_KEY environment variable. 从 OPENAI_API_KEY 环境变量读取的 API 密钥。</summary>
    ...
    /// <summary>Request DTO for the OpenAI embeddings API. OpenAI 向量 API 的请求 DTO。</summary>
    private sealed record EmbeddingRequest(string Model, string[] Input);

    /// <summary>Response DTO from the OpenAI embeddings API. OpenAI 向量 API 的响应 DTO。</summary>
