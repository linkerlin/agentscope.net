...
/// 对应 Java: io.agentscope.harness.agent.skill.curator.AbstractAgentCreatedFilter
/// </summary>
public abstract class AbstractAgentCreatedFilter : ISkillVisibilityFilter
{
    /// <summary>判断技能是否由 Agent 创建（默认按 SourcePath 是否落在 agent-created 目录判断）。</summary>
    ...
    /// <summary>子类实现：对 agent-created 技能的具体过滤策略。</summary>
...
/// <summary>放行所有 Agent 创建技能的过滤器（用于开放策略场景）。</summary>
...
/// <summary>拒绝所有 Agent 创建技能的过滤器（用于严格安全策略场景）。</summary>
